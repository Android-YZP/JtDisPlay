...
import com.jt.display.bean.ShipmentBean.DataBean.MdcShipmentBean.MdcShipmentCarListBean;


public class MdcShipmentAdapter extends ListBaseAdapter<MdcShipmentCarListBean> {


    public MdcShipmentAdapter(Context context) {
        super(context);
    }

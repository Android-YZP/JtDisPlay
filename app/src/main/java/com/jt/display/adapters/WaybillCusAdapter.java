...
public class WaybillCusAdapter extends ListBaseAdapter<WaybillAgingCusBean.DataBean.RecordsBean> {


    public WaybillCusAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.item_waybill_cus;
    }
...
//        View rootView = holder.getView(R.id.ll_root_view);
        ...
        tvLicence.setText(mDataList.get(position).getCustomerName());

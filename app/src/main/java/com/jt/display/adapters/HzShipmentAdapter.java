...
import com.jt.display.bean.ShipmentBean.DataBean.HzShipmentBean.HzShipmentCarListBean;


public class HzShipmentAdapter extends ListBaseAdapter<HzShipmentCarListBean> {


    public HzShipmentAdapter(Context context) {
        super(context);
    }

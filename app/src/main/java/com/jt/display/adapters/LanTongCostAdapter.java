...
import com.jt.display.bean.ChannelCityOrderCostReportBean.DataBean.NanTongOrderCostListBean;


public class LanTongCostAdapter extends ListBaseAdapter<NanTongOrderCostListBean> {
